...
from pyOpt import MMA
from pyOpt import GCMMA
...
print(opt_prob.solution(10))

# Instantiate Optimizer (MMA) & Solve Problem
mma = MMA()
mma.setOption('IPRINT', 0)
mma(opt_prob, sens_type='FD')
print(opt_prob.solution(11))

# Instantiate Optimizer (GCMMA) & Solve Problem
gcmma = GCMMA()
gcmma.setOption('IPRINT', 0)
gcmma(opt_prob, sens_type='FD')
print(opt_prob.solution(12))
